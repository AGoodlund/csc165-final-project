...
//below were moved out of display()
	...
	public int getWindowX(){ return canvasWidth; }
	public int getWindowY(){ return canvasHeight; }
...
/** change the size of an existing viewport */
	public void changeViewportSize(String name, float bottom, float left, float width, float height){
		viewportList.get(name).setNewDimensions(left, bottom, width, height);
	}
