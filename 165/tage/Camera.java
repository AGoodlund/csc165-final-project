...
public class Camera
{
	...
	//DON'T FORGET THE JAVADOC STUFF
/** rotates camera up and down around its U vector  */
...
//TODO:this is the right method, but need to make it so it doesn't only work in the +x direction
	...
	private void yaw(float rad, boolean isGlobal){		//works perfectly
		if(isGlobal){
			...
			v.rotateAxis(rad, defaultV.x(), defaultV.y(), defaultV.z());
			n.rotateAxis(rad, defaultV.x(), defaultV.y(), defaultV.z());
		}
		else{
			u.rotateAxis(rad, v.x(), v.y(), v.z());
